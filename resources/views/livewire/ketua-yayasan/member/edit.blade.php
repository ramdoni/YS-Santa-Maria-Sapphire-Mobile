            ...
            <div class="card">
                <div class="body">
                    <ul class="nav nav-tabs">                                
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#anggota_rekomendasi"><i class="fa fa-users"></i> Anggota Rekomendasi</a></li>
                    </ul>
                    <div class="tab-content px-0">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <table class="table table-hover m-b-0 c_list">
                                        ...
                                        <!-- <tr>
                                            ...
                                            <tr>
                                                <th style="background:#eee;">No KTP</th>
                                                <td>{{$data->Id_Ktp}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Nama (sesuai KTP)</th>
                                                <td>{{$data->name}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Nama yang dicantumkan di KTA</th>
                                                <td>{{$data->name_kta}}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th style="background:#eee;">Tempat / Tanggal Lahir</th>
                                                <td>{{$data->tempat_lahir}} / {{$data->tanggal_lahir}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Kota / Kabupaten</th>
                                            ...
                                            <tr>
                                                <th style="background:#eee;">Alamat</th>
                                                <td>{{$data->address}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Jenis Kelamin</th>
                                                <td>{{$data->jenis_kelamin}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">No Telepon</th>
                                                <td>{{$data->phone_number}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Golongan Darah</th>
                                                <td>{{$data->blood_type}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Status Keanggotaan</th>
                                            ...
                                            <tr>
                                                <th style="background:#eee;">Uang Pendaftaran</th>
                                                <td>{{format_idr($data->uang_pendaftaran)}}</td>
                                            </tr>
                                            <tr>
                                                <th style="background:#eee;">Pas Foto</th>
                                                <td>
                                                    @if(!empty($data->pas_foto))
                                            ...
                                            <tr>
                                                <th style="background:#eee;">Foto KK</th>
                                                <td>
                                                    @if(!empty($data->foto_kk))
                        ...
                        <div class="tab-pane" id="anggota_rekomendasi">
                            <div class="row">
                                <table class="table table-striped table-hover m-b-0 c_list">
                                <thead>
                                    <tr>

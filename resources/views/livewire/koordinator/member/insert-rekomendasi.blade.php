<div class="row" id="rekomendasi_anggota_{{$num}}">
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label>No. Form</label>
                <input type="text" class="form-control" placeholder="Enter Form No" wire:model="form_no">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control" wire:model="koordinator_id">
                    ...
                    @foreach(
                    \App\Models\UserMember::join('users','users.id','=','user_member.user_id')->where('users.user_access_id',3)->where('status',2)->select('user_member.*')->orderBy('user_member.id','DESC')->get() as $koordinator)
    ...
    <div class="col-md-6">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <label>Iuran Tetap <strong class="text-danger">Rp. {{format_idr(get_setting('iuran_tetap'))}}</strong> (Rp {{format_idr($total_iuran_tetap )}})</label>
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="file" class="form-control" wire:model="file_konfirmasi">

        ...
        <div class="row" {!!(!$show_form1?'style="display:none"':'')!!}>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <a href="javascript:void(0)" class="badge badge-info mt-1 ml-0" wire:click="checkKTP"><i class="fa fa-check"></i> Check Nomor KTP</a>
                    @if($messageKtp==1)
                    <div class="alert alert-warning alert-dismissible" role="alert">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                        ...
                        @foreach(
                        \App\Models\UserMember::join('users','users.id','=','user_member.user_id')->where('users.user_access_id',3)->select('user_member.*')->orderBy('user_member.id','DESC')->get() as $koordinator)
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputName">No. Form</label>
                            <input type="text" class="form-control" id="extend1_form_no" placeholder="Enter Form No" wire:model="extend1_form_no">
                            
                            @error('extend1_form_no') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputAlamat">No KTP</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputAlamat">Iuran Tetap <strong class="text-danger">Rp. {{format_idr(get_setting('iuran_tetap'))}}</strong> (Rp {{format_idr($extend1_total_iuran_tetap )}})</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="exampleInputAlamat">Sumbangan <strong class="text-danger">Rp. {{format_idr(get_setting('sumbangan'))}}</strong>  (Rp {{format_idr($extend1_total_sumbangan)}})</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputAlamat">Uang Pendaftaran - Sukarela Minimum <strong class="text-danger">Rp. {{format_idr(get_setting('uang_pendaftaran'))}}</strong></label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>{{ __('Tanggal Aktif')}}</label>
                            <input type="date" class="form-control" wire:model="tanggal_diterima1" />
                            @error('tanggal_diterima1')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
                    <div class="form-group">
                        <label>{{ __('Koordinator')}}</label>
                        <select class="form-control" wire:model="koordinator_id1">
                            <option value=""> --- Select Koordinator --- </option>
                            <option value="1">Kantor</option>
                            @foreach(
                            \App\Models\UserMember::join('users','users.id','=','user_member.user_id')->where('users.user_access_id',3)->select('user_member.*')->orderBy('user_member.id','DESC')->get() as $koordinator)
                        ...
                        @error('koordinator_id1') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <hr />
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleInputName">No. Form</label>
                            <input type="text" class="form-control" id="extend2_form_no" placeholder="Enter Form No" wire:model="extend2_form_no">
                            @error('extend2_form_no') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputAlamat">No KTP</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>{{ __('Tanggal Aktif')}}</label>
                            <input type="date" class="form-control" wire:model="tanggal_diterima2" />
                            @error('tanggal_diterima2')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
                    <div class="form-group">
                        <label>{{ __('Koordinator')}}</label>
                        <select class="form-control" wire:model="koordinator_id2">
                            <option value=""> --- Select Koordinator --- </option>
                            <option value="1">Kantor</option>
                            @foreach(
                            \App\Models\UserMember::join('users','users.id','=','user_member.user_id')->where('users.user_access_id',3)->select('user_member.*')->orderBy('user_member.id','DESC')->get() as $koordinator)
                        ...
                        @error('koordinator_id2') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <hr />

...
namespace App\Http\Livewire\Anggota\Member;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.anggota.member.index')
                        ->with([
                            'data' => $this->data
                        ]);
        //return view('livewire.anggota.member.index')->with(['data'=>$data]);
    }
     ...
     public function mount()
    {
     ...
     public function save(){
        ...
        return redirect()->route('anggota.member');
    }
}

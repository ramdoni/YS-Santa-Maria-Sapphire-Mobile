...
namespace App\Http\Livewire\Anggota\Iuran;
...
class Insert extends Component
{
    ...
    {
        return view('livewire.anggota.iuran.insert');
    }
    ...
    {
        $this->total = 0;$this->total_iuran_tetap='';
        if($this->iuran_tetap > 0){
    ...
    { 
        ...
        return redirect()->route('anggota.iuran');
    }
}

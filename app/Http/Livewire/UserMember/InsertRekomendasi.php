...
class InsertRekomendasi extends Component
{
    public $num;
    ...
    {
        return view('livewire.user-member.insert-rekomendasi');
    }
    ...
    public function checkKTPWaris1()
    {
		...
		$check = UserMember::where('Id_Ktp',$this->Id_Ktpwaris1)->first();
		if($check){
    ...
    public function save($param)
    {
		...
		$no_anggota = date('ym',strtotime($this->tanggal_diterima)).str_pad(($param['no_anggota']),5, '0', STR_PAD_LEFT);

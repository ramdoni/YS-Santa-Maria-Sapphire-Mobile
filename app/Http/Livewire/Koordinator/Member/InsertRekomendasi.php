...
class InsertRekomendasi extends Component
{
    ...
    {
        return view('livewire.koordinator.member.insert-rekomendasi');
    }
    ...
    public function save($param)
    {
		...
		// $no_anggota = date('ym',strtotime($this->tanggal_diterima)).str_pad((UserMember::count()+1),6, '0', STR_PAD_LEFT);
